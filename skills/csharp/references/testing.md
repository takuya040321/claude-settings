...
```bash
# 基本実行
~/.claude/skills/csharp/scripts/run_tests.sh

# 特定プロジェクトのテスト
~/.claude/skills/csharp/scripts/run_tests.sh src/MyApp.Tests/

# カバレッジレポート付き
~/.claude/skills/csharp/scripts/run_tests.sh --coverage
```
...
```csharp
// src/MyApp.Tests/GlobalUsings.cs
global using Xunit;
global using Moq;
