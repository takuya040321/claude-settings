...
| タスク | API | リファレンス |
|--------|-----|-------------|
| 注文の取得・出荷通知 | Orders API | [references/orders.md](references/orders.md) |
...
- **Orders API** - 注文一覧の取得、注文詳細の取得、注文アイテムの取得、出荷通知（MFN）、スプレッドシート連携
...
- [Orders API](references/orders.md) - 注文の取得・管理・出荷通知
